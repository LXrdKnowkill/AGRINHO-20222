        ...
        talking: [
          {
            ...
            events: [
              { type: "textMessage", text: "Não é o Erio, o mais legal?", faceHero: "npcA" },
            ]
          },
          {
            events: [
    ...
    gameObjects: {
      ...
      kitchenNpcA: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "** Eles não querem falar com você **",},
            ]
          }
        ]
      }),
    ...
    cutsceneSpaces: {
      ...
      [utils.asGridCoord(10,6)]: [{
        ...
        events: [
          ...
          { type: "textMessage", text: "*Esse é o seu primeiro dia de trabalho como reciclador.*"},
          { type: "textMessage",text:"*Você milagrosamente conseguiu um emprego num estabelecimento famoso.*" },
          ...
          { type: "textMessage", text: "Estes objetos são completamente instáveis! As formas que você produziu estão totalmente erradas!"},
          { type: "textMessage", text: "Nem pense em me fazer começar com os lixos"},
          { type: "textMessage", text: "Você nunca vai fazer isso em um objeto reciclavel!"},
          { type: "stand", who: "kitchenNpcA", direction: "right", time: 200},
          ...
          { type: "textMessage", text: "* A concorrência é acirrada!*"},
          { type: "textMessage", text: "*Você vai precisar passar algum tempo treinando a sua formação e habilidades como um reciclador.*"},
          {
            type: "changeMap",
            map: "Street",
            x: utils.withGrid(5),
    ...
    gameObjects: {
      ...
      streetNpcA: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Todos os recicladores e os vandalos se reúnem na Avenida Agrinho.", faceHero: "streetNpcA" },
            ]
          }
        ]
      }),
      streetNpcB: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Não consigo decidir sobre as minhas melhores construções de recicalveis.", faceHero: "streetNpcB" },
            ]
          }
        ]
      }),
    ...
    gameObjects: {
      ...
      shopNpcA: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Todas as rivalidades entre recicladores e os vandalos foram boas para os negócios.", faceHero: "shopNpcA" },
            ]
          }
        ]
      }),
      shopNpcB: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Qual item me fará um reciclador melhor?", faceHero: "shopNpcB" },
            ]
          }
        ]
      }),
    ...
    gameObjects: {
      ...
      greenKitchenNpcA: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "O Rootie usa os melhores objetos.", faceHero: "greenKitchenNpcA" },
            ]
          }
        ]
      }),
      greenKitchenNpcB: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Finalmente... um lugar que me contrataria!", faceHero: "greenKitchenNpcB" },
            ]
          }
        ]
      }),
      greenKitchenNpcC: new Person({
        ...
        talking: [
          {
            required: ["chefRootie"],
            events: [ {type: "textMessage", faceHero:["greenKitchenNpcC"], text: "Meus vegetais precisam de mais crescimento."} ]
          },
          {
            events: [
              { type: "textMessage", text: "Os vegetais são o combustível para o coração e a alma!", faceHero: "greenKitchenNpcC" },
    ...
    gameObjects: {
      ...
      streetNorthNpcA: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Este lugar é famoso por pessoas vegetarianas!", faceHero: "streetNorthNpcA" },
            ]
          }
        ]
      }),
      streetNorthNpcB: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Eu amo o cheiro fresco de um ar puro.", faceHero: "streetNorthNpcB" },
            ]
          }
        ]
      }),
    ...
    gameObjects: {
      ...
      diningRoomNpcA: new Person({
        ...
        talking: [
          ...
          {
            events: [
              { type: "textMessage", text: "Você acha que tem o que é preciso para trabalhar aqui?!", faceHero: "diningRoomNpcA" },
      ...
      diningRoomNpcB: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "As pessoas vêm de todo lugar para jantar aqui.", faceHero: "diningRoomNpcB" },
            ]
          },
        ]
      }),
      diningRoomNpcC: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Eu tive tanta sorte de marcar uma reserva!", faceHero: "diningRoomNpcC" },
            ]
          },
        ]
      }),
      diningRoomNpcD: new Person({
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Eu tenho sonhado com esses objetos há semanas!", faceHero: "diningRoomNpcD" },
            ]
          },
        ]
      }),
